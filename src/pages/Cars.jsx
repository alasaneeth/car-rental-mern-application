...
const Cars = () => {
  ...
  return (
    <div>
      <div className='flex flex-col items-center py-20 bg-blend-lighten max-md:px-4'>
        <Title title="Available Cars" subTitle="Brows our selection of premium vehicless avliable for your next adventure"/>
